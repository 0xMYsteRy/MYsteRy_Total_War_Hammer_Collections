...
function cutscene_intro_play()
	...
	local cutscene_intro = campaign_cutscene:new(
		...
		35,													-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh2_main_hef_eataine/scenes/eataine_flyover_s01.CindyScene", true, true);
		end,
		0
	);
