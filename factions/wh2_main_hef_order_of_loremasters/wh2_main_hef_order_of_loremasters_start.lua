...
function cutscene_intro_play()
	output("cutscene_intro_play() called");
	
	local advice_to_play = {};
	advice_to_play[1] = "war.camp.advice.war.001";
	advice_to_play[2] = "pro2.camp.Isabella.intro.003";
	advice_to_play[3] = "war.camp.advice.race.high_elves.002";
	
	local cutscene_intro = campaign_cutscene:new(
		local_faction .. "_intro",							-- string name for this cutscene
		60.5,												-- length of cutscene in seconds
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_warhammer/factions/wh_main_brt_carcassonne/scenes/carcassonne_main_flyover_s01.CindyScene", true, true);
		end,
		0
	);
